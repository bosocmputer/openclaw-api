...
const templates = [
  {
    ...
    summary: 'ร้านขายอะไหล่และบริการยานยนต์ที่ลูกค้ามักถามด้วยชื่ออะไหล่ รุ่นรถ ตำแหน่งอะไหล่ ปีรถ หรือรหัสสินค้า',
    customerQuestionPatterns: [
      'ถามราคา ยอดคงเหลือ หรือมีสินค้าไหมจากชื่ออะไหล่ + รุ่นรถ',
      'ถามด้วยตำแหน่งอะไหล่ เช่น หน้า/หลัง ซ้าย/ขวา LH/RH บน/ล่าง',
      'ถามจากรหัสสินค้า เบอร์อะไหล่ เบอร์สายพาน หรือรูปสินค้า',
    ],
    mainCategories: ['อะไหล่เครื่องยนต์', 'ช่วงล่าง', 'เบรก', 'ระบบไฟ', 'ตัวถัง', 'ของเหลวและอุปกรณ์สิ้นเปลือง'],
    synonyms: ['โช้ค/โช๊ค/โช้ก/โช้คอัพ', 'เบรก/เบรค', 'คลัช/ครัช', 'หน้า/หลัง/ซ้าย/ขวา/LH/RH'],
    safetyRules: [
      'เก็บคำพ้องเป็นตัวช่วยตีความ keyword เท่านั้น กติกาการยืนยันข้อมูลให้ยึด SOUL tool contract',
      'รักษารหัสสินค้าและเบอร์อะไหล่ตามที่ลูกค้าพิมพ์ ไม่ตัดขีดหรือเลขสำคัญ',
    ],
    soulBlock: `## Business Profile
ธุรกิจ: ธุรกิจอะไหล่และบริการยานยนต์

บริบทคำถาม:
- ลูกค้ามักถามราคา ยอดคงเหลือ หรือสินค้าใกล้เคียงด้วยชื่ออะไหล่ร่วมกับยี่ห้อ รุ่นรถ ปีรถ ตำแหน่งอะไหล่ หรือรหัสสินค้า
- ตำแหน่งที่พบบ่อย: หน้า/หลัง ซ้าย/ขวา LH/RH บน/ล่าง
- เบอร์อะไหล่หรือเบอร์สายพาน เช่นรูปแบบตัวอักษร+ตัวเลข+ขีด ให้ถือเป็น keyword สำคัญและรักษาตามที่ลูกค้าพิมพ์

Keyword hints:
- คำสะกดใกล้เคียงในหมวดเดียวกันให้ใช้ช่วยตั้ง keyword อย่างระมัดระวัง เช่น โช้ค/โช๊ค/โช้ก/โช้คอัพ, เบรก/เบรค, คลัช/ครัช
- ถ้าลูกค้าถามหลายรายการในข้อความเดียว ให้แยก keyword ของแต่ละรายการก่อนตรวจสอบตามสิทธิ์ของ agent`,
  },
  {
